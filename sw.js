...
console.log('service worker Titty Attack')
console.log('service worker Titty Attack')
console.log('service worker Titty Attack')
console.log('service worker Titty Attack')
console.log('service worker Titty Attack')
...
const prefetch = [
    ...
    'icons/icon.svg',
    'icons/safari-pinned-tab-16x16.svg',
    'index.html',
    ...
    'https://cdn.jsdelivr.net/g/fuse@2.6.1,react@15.4.0(react.min.js+react-dom.min.js',
    'https://cdn.jsdelivr.net/lodash/3.10.1/lodash.min.js',
    'https://cdn.jsdelivr.net/npm/lodash@2.4.2/dist/lodash.min.js',
...
addEventListener('activate', event =>
    event.waitUntil(
        Promise.all([
            clients.claim(),
            // Delete old caches.
            caches.keys().then(keys => Promise.all(keys.map(key => key == BUILD_REV || caches.delete(key))))
        ])
    )
)
